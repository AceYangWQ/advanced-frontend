...
// 函数的防抖
// function debouce(func, wait = 300, immediate = false) {
//   let timer = null
//   return function () {
//     clearTimeout(timer)
//     timer = setTimeout(() => {
...
//   console.log('submit')
// }
// submit.onclick = debouce(handle)

// 是否支持立即执行
// function debouce(func, wait = 300, immediate = false) {
//   let timer = null
//   return function () {
//     let excute = immediate && !timer
//     clearTimeout(timer)
//     timer = setTimeout(() => {
//       timer = null
//       !immediate ? func.call(this) : ''
//     }, wait)
//     excute ? func.call(this) : ''
//   }
// }
...
// submit.onclick = debouce(handle, 500, true)
...
window.onscroll = throttle(scroll)
