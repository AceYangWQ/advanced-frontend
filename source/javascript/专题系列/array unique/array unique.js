...
// console.log(
//   unique(array3, false, function (item, index, array) {
...
// 这种方法是利用一个空的 Object 对象，我们把数组的值存成 Object 的 key 值，
// 比如 Object[value1] = true，在判断另一个值的时候，如果 Object[value2]存在的话，就说明该值是重复的。示例代码如下
var array = [1, 2, 1, 1, '1']
function unique(array) {
  var obj = {}
